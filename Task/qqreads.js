...
#企鹅读书获取更新body
https:\/\/mqqapi\.reader\.qq\.com\/log\/v4\/mqq\/track url script-request-body https://raw.githubusercontent.com/ziye888/JavaScript/main/Task/QQread.js

#企鹅读书获取时长cookie
https:\/\/mqqapi\.reader\.qq\.com\/mqq\/addReadTimeWithBid? url script-request-header https://raw.githubusercontent.com/ziye888/JavaScript/main/Task/QQread.js

############## loon

//企鹅读书获取更新body
http-request https:\/\/mqqapi\.reader\.qq\.com\/log\/v4\/mqq\/track script-path=https://raw.githubusercontent.com/ziye888/JavaScript/main/Task/QQread.js,requires-body=true, tag=企鹅读书获取更新body

//企鹅读书获取时长cookie
http-request https:\/\/mqqapi\.reader\.qq\.com\/mqq\/addReadTimeWithBid? script-path=https://raw.githubusercontent.com/ziye888/JavaScript/main/Task/QQread.js, requires-header=true, tag=企鹅读书获取时长cookie

############## surge

//企鹅读书获取更新body
企鹅读书获取更新body = type=http-request,pattern=https:\/\/mqqapi\.reader\.qq\.com\/log\/v4\/mqq\/track,script-path=https://raw.githubusercontent.com/ziye888/JavaScript/main/Task/QQread.js, 

//企鹅读书获取时长cookie
企鹅读书获取时长cookie = type=http-request,pattern=https:\/\/mqqapi\.reader\.qq\.com\/mqq\/addReadTimeWithBid?,script-path=https://raw.githubusercontent.com/ziye888/JavaScript/main/Task/QQread.js, 
      ...
      setTimeout(
        function () {
          if (i == 0) {
            ...
            i == 2&&new Date(new Date().getTime() + 8 * 60 * 60 * 1000).getHours() == 0) qqreadtrack();//更新
	  else if (i == 3 && task.data && task.data.treasureBox.doneFlag == 0)
            qqreadbox();// 宝箱     		
          else if (
            i == 6 &&
            task.data &&
          ...
          else if (i == 7&& K < qqreadbdArr.length - 1) {
            K += 1;
            all();
          } else if (i == 7&& K == qqreadbdArr.length - 1) {
            showmsg(); // 通知
